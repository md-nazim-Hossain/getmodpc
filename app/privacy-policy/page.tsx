...
const POLICY_SECTIONS: PolicySection[] = [
    ...
    content: (
      <>
        <P>
          ...
          <a
            href='https://moddroid.demos.web.id'
            className='text-primary hover:underline'
            target='_blank'
            rel='noopener noreferrer'
          >
            https://moddroid.demos.web.id
          </a>
          .
        </P>
      </>
  ...
  },
  {
    ...
    content: (
      <P>
        <strong>Suggested text:</strong> If you have an account on this site, or
        have left comments, you can request to receive an exported file of the
        personal data we hold about you, including any data you have provided to
        us. You can also request that we erase any personal data we hold about
  ...
  },
  {
    ...
    content: (
      <P>
        <strong>Suggested text:</strong> Visitor comments may be checked through
...
export default function PrivacyPolicyPage() {
  return (
    <main className='min-h-screen bg-white'>
      {/* ── Breadcrumb ─────────────────────────────────────────────────── */}
      <div className='container max-w-5xl mx-auto px-4 pt-4 pb-2'>
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem>
